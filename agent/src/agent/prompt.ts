...
export const AGENT_SCRIPT_REGISTRY: readonly AgentScriptDefinition[] = [
  {
    ...
    example:
      "uv run --project agent/scripts python -m agent_invest_scripts.read_memory --scope strategy --user user-123 --strategy strategy-456",
  },
  {
    name: "write_memory",
    ...
    example:
      'uv run --project agent/scripts python -m agent_invest_scripts.write_memory --scope strategy --user user-123 --strategy strategy-456 --section tried --mode append --content "- 2026-04-25: lookback=90, top_k=5 -> Sharpe 0.9"',
