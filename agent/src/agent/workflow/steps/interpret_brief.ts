...
- "pair_trade" / "hedge_overlay" / "long_short_portfolio": involve shorts -- only use when the brief explicitly opts into shorts/hedging/market-neutral/relative-value, and set allowed_sides accordingly.
