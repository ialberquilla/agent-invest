...
METADATA = TemplateMetadata(
    id="momentum",
    category="tactical",
    preferred_factors=["roc_90d", "rs_vs_btc", "pct_above_sma_200d"],
    default_universe={
    ...
    slot_schema={
        ...
        "signal_threshold": {"type": "float", "required": True},
...
class Momentum:
    ...
    def build(
        ...
        for coin_id in universe["coin_id"]:
            ...
            signals[coin_id] = (indicator > threshold).astype(int).diff().fillna(0)
